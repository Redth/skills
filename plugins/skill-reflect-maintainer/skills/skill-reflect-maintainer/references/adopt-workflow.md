...
3. Run `tools/adopt.py adopt`. Add `--with-auto` only if the author wants the Copilot CLI auto extension vendored too.
...
6. Run `tools/adopt.py doctor --to <plugin-dir>` and summarize results.
